...
{columns: [
{text:
'Rechnung für: '+ this.User.firstName + ' ' + this.User.lastName,
fontSize: 13,
margin: [0, 16, 0, 0]
},
{
...
{text:
'Adresse: '+ this.User.address + ' ' + this.rolle,
fontSize: 13,
margin: [0, 16, 0, 0]
},
{text:
'Ihre Fahrt vom: ' + item.date,
fontSize: 13,
margin: [0, 30, 0, 0]
},
{text:
'Startpunkt: ' + item.startPoint,
fontSize: 12,
margin: [0, 16, 0, 0]
},
{text:
...
{text:
'Distanz: ' + item.completeDistance + ' km',
fontSize: 12,
margin: [0, 16, 0, 0]
},
{text:
