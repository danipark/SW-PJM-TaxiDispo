...
export class TaxiService {
  ...
  addTaxi(taxi: Taxi): Observable<any> {
    return this.http
      .post<Taxi>("http://localhost:3000/api/taxi", taxi, this.httpOptions)
      .pipe(catchError(this.handleError<Taxi>("Add Taxi")));
  }

  getTaxi(id): Observable<Taxi[]> {
    return this.http.get<Taxi[]>("http://localhost:3000/api/taxi/" + id).pipe(
  ...
  getTaxiList(): Observable<Taxi[]> {
    return this.http.get<Taxi[]>("http://localhost:3000/api/taxi").pipe(
  ...
  updateTaxi(id, taxi: Taxi): Observable<any> {
    return this.http
      .put("http://localhost:3000/api/taxi/" + id, taxi, this.httpOptions)
      .pipe(
  ...
  deleteTaxi(id): Observable<Taxi[]> {
    return this.http
      .delete<Taxi[]>("http://localhost:3000/api/taxi/" + id, this.httpOptions)
      .pipe(
